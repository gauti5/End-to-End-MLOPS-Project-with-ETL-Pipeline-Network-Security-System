...
class DataTransformation:
    ...
    @staticmethod # we are not required initialize any object with help of class name
    ...
    def initiate_data_transformation(self)->DataTransformationArtifact:
        ...
        try:
            ...
            train_arr=np.c_[transformed_input_train_feature, np.array(target_feature_train_df)] # Combines both
