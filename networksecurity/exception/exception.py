...
class NetworkSecurityException(Exception):
    ...
    def __init__(self, error_message, error_details:sys): # error details are coming from SYSTEM
        self.error_message=error_message
        _,_, exc_tb=error_details.exc_info()  # gives entire execution details
