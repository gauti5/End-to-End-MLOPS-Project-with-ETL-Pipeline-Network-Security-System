...
from networksecurity.entity.artifact_entity import DataIngestionArctifact, DataTransformationArtifact, DataValidationArtifact, ModelTrainerArtifact
...
class TrainingPipeline:
    ...
    def start_data_ingestion(self):
        try:
            ...
            logging.info(f"data ingestion completed and artifcat : {data_ingestion_artifact}")
    ...
    def start_data_validation(self, data_ingestion_artifact: DataIngestionArctifact):
        try:
            ...
            logging.info(f"Data Validation Completed and Artiface: {data_validation_artifact}")
    ...
    def start_data_transformation(self, data_validation_artifact: DataValidationArtifact):
        try:
            ...
            logging.info(f"Data Transformation Completed and Artifacr : {data_transformation_artifact}")
